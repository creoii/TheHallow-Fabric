...
public class FeatureRegistry {
    ...
    public static final ConfiguredFeature<?, ?> RED_MOSS_PATCH_BONEMEAL = Feature.VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(Tags.Blocks.RED_MOSS_REPLACEABLE.getId(), new SimpleBlockStateProvider(BlockRegistry.RED_MOSS_BLOCK.getDefaultState()), () -> RED_MOSS_VEGETATION, VerticalSurfaceType.FLOOR, ConstantIntProvider.create(1), 0.0F, 5, 0.4F, UniformIntProvider.create(1, 2), 0.75F));
    public static final ConfiguredFeature<?, ?> PATCH_CANDLES = Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.CANDLE.getDefaultState()), new SimpleBlockPlacer()).whitelist(ImmutableSet.of(BlockRegistry.HALLSTONE, BlockRegistry.TENEBRITE)).tries(32).cannotProject().build()).decorate(Decorator.HEIGHTMAP_SPREAD_DOUBLE.configure(new HeightmapDecoratorConfig(Heightmap.Type.MOTION_BLOCKING)).spreadHorizontally()).spreadHorizontally().applyChance(4);
    public static final ConfiguredFeature<?, ?> RED_MOSS_PATCH = Feature.VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(Tags.Blocks.RED_MOSS_REPLACEABLE.getId(), new SimpleBlockStateProvider(BlockRegistry.RED_MOSS_BLOCK.getDefaultState()), () -> RED_MOSS_VEGETATION, VerticalSurfaceType.FLOOR, ConstantIntProvider.create(1), 0.0F, 5, 0.8F, UniformIntProvider.create(4, 7), 0.3F));
    ...
    public static final ConfiguredFeature<?, ?> RED_MOSS_PATCH_CEILING = Feature.VEGETATION_PATCH.configure(new VegetationPatchFeatureConfig(Tags.Blocks.RED_MOSS_REPLACEABLE.getId(), new SimpleBlockStateProvider(BlockRegistry.RED_MOSS_BLOCK.getDefaultState()), () -> ConfiguredFeatures.CAVE_VINE_IN_MOSS, VerticalSurfaceType.CEILING, UniformIntProvider.create(1, 2), 0.0F, 5, 0.0F, UniformIntProvider.create(4, 7), 0.3F));

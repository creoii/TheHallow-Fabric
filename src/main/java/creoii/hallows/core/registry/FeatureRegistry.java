...
public class FeatureRegistry {
    ...
    public static final ConfiguredFeature<?, ?> TREES_EBONY = EBONY.decorate(Decorator.HEIGHTMAP.configure(new HeightmapDecoratorConfig(Heightmap.Type.OCEAN_FLOOR)).decorate(Decorator.WATER_DEPTH_THRESHOLD.configure(new WaterDepthThresholdDecoratorConfig(0))).spreadHorizontally()).decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(10, 0.1F, 1)).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(256))));
    public static final ConfiguredFeature<?, ?> TREES_BLOOD_EBONY = BLOOD_EBONY.decorate(Decorator.HEIGHTMAP.configure(new HeightmapDecoratorConfig(Heightmap.Type.OCEAN_FLOOR)).decorate(Decorator.WATER_DEPTH_THRESHOLD.configure(new WaterDepthThresholdDecoratorConfig(0))).spreadHorizontally()).decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(10, 0.1F, 1)).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(256))));
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> ASPHODEL = Feature.TREE.configure(new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(BlockRegistry.ASPHODEL_LOG.getDefaultState()), new ForkingTrunkPlacer(5, 2, 2), new SimpleBlockStateProvider(Blocks.AIR.getDefaultState()), new SimpleBlockStateProvider(BlockRegistry.ASPHODEL_SAPLING.getDefaultState()), new AcaciaFoliagePlacer(ConstantIntProvider.create(0), ConstantIntProvider.create(0)), new TwoLayersFeatureSize(4, 3, 3)).build());
    ...
    public static final ConfiguredFeature<?, ?> TREES_ASPHODEL = Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(ImmutableList.of(LARGE_ASPHODEL.withChance(0.1F)), ASPHODEL)).decorate(Decorator.HEIGHTMAP.configure(new HeightmapDecoratorConfig(Heightmap.Type.OCEAN_FLOOR)).decorate(Decorator.WATER_DEPTH_THRESHOLD.configure(new WaterDepthThresholdDecoratorConfig(0))).spreadHorizontally().decorate(Decorator.COUNT_EXTRA.configure(new CountExtraDecoratorConfig(0, 0.8F, 1)).decorate(Decorator.COUNT_MULTILAYER.configure(new CountConfig(256)))));
    ...
    public static final ConfiguredFeature<?, ?> PATCH_CANDLES = Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new WeightedBlockStateProvider(DataPool.<BlockState>builder().add(Blocks.CANDLE.getDefaultState(), 8).add(BlockRegistry.TALL_CANDLE.getDefaultState(), 4).add(BlockRegistry.CANDLE_SKULL.getDefaultState(), 1).build()), new SimpleBlockPlacer()).whitelist(ImmutableSet.of(BlockRegistry.HALLSTONE, BlockRegistry.TENEBRITE)).tries(32).cannotProject().build()).decorate(Decorator.HEIGHTMAP_SPREAD_DOUBLE.configure(new HeightmapDecoratorConfig(Heightmap.Type.MOTION_BLOCKING)).spreadHorizontally()).spreadHorizontally().repeatRandomly(5).applyChance(4);
